  ...
  try {
    ...
    body.innerHTML = `
      ...
      <div style="padding:0 16px 8px;display:flex;flex-direction:column;gap:8px">
        ...
        <button id="md-msg" style="background:var(--capsule);border:1px solid var(--border-strong);color:var(--text);padding:8px;border-radius:4px;font-size:var(--font-scale-micro);cursor:pointer;margin-top:8px">发消息</button>
        <button id="md-back" style="background:transparent;border:1px solid var(--border-strong);color:var(--text-mute);padding:8px;border-radius:4px;font-size:var(--font-scale-micro);cursor:pointer">返回成员列表</button>
      </div>
    `;
