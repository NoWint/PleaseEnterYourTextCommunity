// src/app/components/dialogs/settings-v2/models.tsx
// 设置对话框「模型」页签（照抄 opencode settings-v2/models.tsx 的骨架，
// 去掉 model 管理）：IM 版为机器人管理入口 → 关闭设置对话框并跳转 /bots
  ...
  return (
    <>
      <div class="settings-v2-tab-header">
        <h2 class="settings-v2-tab-title">{dialogsT("settings.models.title")}</h2>
      </div>
